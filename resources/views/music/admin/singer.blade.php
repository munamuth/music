				...
				<div class="row">
					<div class="panel panel-default" id="addmusic">
						<div class="panel-heading">
							<h3 class="panel-title text-center">Add Singer</h3>
						</div>
						<div class="panel-body">
							<form action="{{ URL::to('/admin/singer/store') }}" method="post" class="form-horizontal" role="form" id="add_music" enctype="multipart/form-data">		
...
@section('footer')
	...
	<script type="text/javascript" src="/asset/js/singer.js">
	</script>
	<script type="text/javascript">
		$('#singer').prop('class', 'active');
	</script>
@stop